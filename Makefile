...
all: testInvader testLecture Pompier
...
Pompier:
	javac -d bin -classpath bin/gui.jar -sourcepath src src/tests/Pompier.java
...
run: 
	java -classpath bin:bin/gui.jar tests/Pompier cartes/carteSujet.map
